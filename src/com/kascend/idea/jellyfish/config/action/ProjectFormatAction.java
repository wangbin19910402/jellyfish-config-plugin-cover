...
import com.kascend.idea.jellyfish.config.project.format.ProjectFormatTool;
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        try {
            ...
            if (MessagesUtil.confirm(project, "是否初始化该项目？", generateConfirmMessage)) {
                boolean isSuccess = ProjectFormatTool.format(projectBasePath, ProjectEnum.toProjectFormatEnum(selectedProjectFormatName));
                if (isSuccess) {
